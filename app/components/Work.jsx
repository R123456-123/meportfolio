    ...
    return (
        ...
        id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                Welcome to my portfolio. Here are some of the projects I have worked on.
            </motion.p>
                         ...
                         group-hover:bottom-7'>
                            ...
                            <div className='border rounded-full border-black w-9 aspect-square
                             flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition'>
                                <a href="https://github.com/R123456-123"><Image src={assets.send_icon} alt='' className='w-5'/></a>
                            </div>
                        </div>
                    </motion.div>
                ))}
            ...
            href="https://github.com/R123456-123" className='w-max flex items-center justify-center gap-2 text-gray-700
